            ...
            <div className="mt-8 grid gap-6">
              <Card className="border-[#4d6e5e] dark:border-[#a8d5ba] shadow-lg">
                ...
                <CardContent>
                  <ul className="list-disc list-inside m-4 space-y-2 text-sm text-gray-500 dark:text-gray-400">
                    <li className="text-gray-800 dark:text-gray-300">
                      Local-first analytics platform for Strava data with
                      privacy-focused architecture—all data stays on your
                      machine
                    </li>
                    <li className="text-gray-800 dark:text-gray-300">
                      Ingests Strava export (CSV + FIT files) into SQLite
                      database for custom analysis and visualization
                    </li>
                    <li className="text-gray-800 dark:text-gray-300">
                      Features interactive dashboard with activity breakdown
                      charts, heatmaps, and route explorer
                    </li>
                    <li className="text-gray-800 dark:text-gray-300">
                      Computes advanced training metrics: TSS, CTL/ATL/TSB
                      (fitness/fatigue/form), HR zones, and TRIMP
                    </li>
                    <li className="text-gray-800 dark:text-gray-300">
                      Built with Python, Flask, SQLite, and Leaflet.js for
                      maps—designed for athletes who want data ownership
                    </li>
                  </ul>
